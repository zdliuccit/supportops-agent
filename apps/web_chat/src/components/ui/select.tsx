...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between whitespace-nowrap rounded-lg border border-input bg-background px-3 py-2 text-sm outline-none transition-shadow data-[placeholder]:text-muted-foreground/50 focus:border-ring focus:ring-2 focus:ring-ring/20 aria-invalid:border-red-500! aria-invalid:focus:ring-red-200! disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
